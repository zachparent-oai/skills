...
- Keep this `zach-stack` guidance focused on *how to use* the skill well (coverage quality, test quality, selector strategy), not on re-documenting every Playwright command.
...
Short excerpts are included here to anchor the opinionated workflow above to primary docs and the installable skill docs.
